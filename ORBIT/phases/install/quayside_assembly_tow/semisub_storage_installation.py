"""Installation strategies for semisub energy storage systems."""
...
class SemiSubStorageInstallation(InstallPhase):
    """
    Installation module to model the quayside assembly, tow-out and
    installation at sea of energy storage on moored substructures.
    """

    phase = "SemiSub Storage Installation"
    capex_category = "Energy Storage"
    ...
    expected_config = {
        ...
        "port": {
            ...
            "substructure": "int (optional, default: inf)",
    ...
    def __init__(self, config, weather=None, **kwargs):
        """
        Creates an instance of SubstructureInstallation.
    ...
    def system_capex(self):
        """Returns total procurement cost of the semisubmersible energy storage."""

        return self.config["substructure"]["unit_cost"]
    ...
    def initialize_substructure_production(self):
        ...
        try:
            storage = self.config["port"]["substructure"]
