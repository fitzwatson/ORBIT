"""Provides the `Floating Energy Storage` class (added by J. Watson)"""

__author__ = "Josh Watson"
__copyright__ = "Copyright 2023, National Renewable Energy Laboratory"
__maintainer__ = "Jake Nunemaker"
__email__ = "jake.nunemaker@nrel.gov, joshuaw@umass.edu"
...
class SemiSubStorageDesign(DesignPhase):
    """Semi-Submersible Energy Storage Design"""

    expected_config = {
        "site": {"depth": "m"},
        "plant": {"num_turbines": "int"},
        "turbine": {"turbine_rating": "MW"},
        "semisubstorage_design": {
    ...
    def __init__(self, config, **kwargs):
        """
        Creates an instance of `SemiSubStorageDesign`.
        ...
        self._design = self.config.get("semisubstorage_design", {})
    ...
    def run(self):
        ...
        semisubstorage = {
            "mass": self.semisubstorage_mass,
            "unit_cost": self.semisubstorage_cost,
            "towing_speed": self._design.get("towing_speed", 6),
        }

        self._outputs["semisubstorage"] = semisubstorage
    ...
    def truss_cost(self):
        """
        Calculates the cost of the truss for a single semi-submersible. From
        original OffshoreBOS model.
        """
    ...
    @property
    def semisubstorage_mass(self):
        """Returns single semisubstorage mass."""
    ...
    @property
    def semisubstorage_cost(self):
        """Returns single semisubstorage cost."""
    ...
    @property
    def total_semisubstorage_mass(self):
        """Returns mass of all semisubstorages."""

        num = self.config["plant"]["num_turbines"]
        return num * self.semisubstorage_mass
    ...
    def total_cost(self):
        ...
        num = self.config["plant"]["num_turbines"]
        return self.semisubstorage_cost
